...
export default function Model({ ...props }) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/Shoes/shoesAnim.glb')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <group position={[-0.01, 1.34, -0.53]} scale={0.04}>
        <mesh geometry={nodes.Plane001.geometry} material={materials['Material.007']} />
        <mesh geometry={nodes.Plane001_1.geometry} material={materials['Material.011']} />
        <mesh geometry={nodes.Plane001_2.geometry} material={materials['Material.009']} />
      </group>
      <group position={[-0.01, 1.34, -1.55]} rotation={[-Math.PI / 2, 1.57, 0]} scale={0.11}>
        <mesh geometry={nodes.Plane003.geometry} material={materials['Material.010']} />
...
useGLTF.preload('/Shoes/shoesAnim.glb')
